<div>
    ...
    @if($package!=null)
        <table class="min-w-full bg-white ">
            ...
            <tbody class="text-gray-700">
                ...
                <tr>
                    ...
                    <td class="w-1/3 px-4 py-3 text-left"><a href="" wire:click.prevent="pickup({{$info['id']}})">
                        <button type="submit"
                            ...
                            <svg wire:loading wire:target="pickup({{$info['id']}})" class="w-5 h-5 mr-3 -ml-1 text-white animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24">
                            ...
                            <span>Update for Pickup</span>
                        </button>
                        
                    </a>
                </td>
                @else
                <td class="w-1/3 px-4 py-3 text-left">Already Updated for Pickup</td>
                @endif
        ...
        {{--  {{$PTN}}  --}}
    @else
    @if ($successMsg=="Updated for Pickup")
