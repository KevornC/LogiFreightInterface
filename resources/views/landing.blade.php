...
<html lang="en">
  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
      ...
      <div class="container flex flex-wrap items-center justify-between w-full py-2 mx-auto mt-0">
        <div class="flex items-center pl-4">
          <a class="text-2xl font-bold text-white no-underline toggleColour hover:no-underline lg:text-4xl" href="/">
            ...
            <img src="image/logo3.png" id="Logo" width="90px">
          </a>
        </div>
    ...
    <div class="pt-24">
      <div class="container flex flex-col flex-wrap items-center px-3 mx-auto md:flex-row">
        ...
        <div class="flex flex-col items-start justify-center w-full text-center md:w-2/5 md:text-left">
            <p class="w-full uppercase tracking-loose">LogiFreight Limited</p>
            <h1 class="my-4 text-5xl font-bold leading-tight">
              Secure and Legitimate Shipping
            </h1>
            <p class="mb-8 text-2xl leading-normal">
              Get reasonable shipping rate today at LogiFreight Limited!
            </p>
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 p-6 sm:w-1/2">
            ...
            <p class="mb-8 text-gray-600">
                We offer safe and secure package shipping online once your documents have been validated.
              <br />
              <br />
            </p>
          </div>
          <div class="w-full p-6 sm:w-1/2">
            <svg class="w-full mx-auto sm:h-64" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
              <title>Online Loan transfers</title>
              <path
        ...
        <div class="flex flex-col-reverse flex-wrap sm:flex-row">
          <div class="w-full p-6 mt-6 sm:w-1/2">
            <svg class="w-5/6 mx-auto sm:h-64" viewBox="0 0 1176.60617 873.97852" xmlns="http://www.w3.org/2000/svg">
              <title>International Loan Transfers</title>
              <path
          ...
          <div class="w-full p-6 mt-6 sm:w-1/2">
            <div class="align-middle">
              <h3 class="mb-3 text-3xl font-bold leading-none text-gray-800">
                Reasonable Loan Transfers World Wide
              </h3>
              <p class="mb-8 text-gray-600">
                We offer the best rates internationally
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="flex-1 overflow-hidden bg-white rounded-t rounded-b-none shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <div class="w-full px-6 text-xl font-bold text-gray-800">
                No custom fee for $50 usd and under
              </div>
              <p class="px-6 mb-5 text-xl font-bold text-gray-800">
                {{--  {{$rates[0]->business_rate * 100}}%  --}}
                $500.00 per pound
              </p>
            </a>
          </div>
        ...
        <div class="flex flex-col flex-grow flex-shrink w-full p-6 md:w-1/3">
          <div class="flex-1 overflow-hidden bg-white rounded-t rounded-b-none shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <div class="w-full px-6 text-xl font-bold text-gray-800">
               Custom Fee over $50 usd
              </div>
              <p class="px-6 mb-5 text-xl font-bold text-gray-800">
                {{--  {{$rates[2]->business_rate * 100}}%  --}}
                $500.00 per pound plus custom fee
              </p>
            </a>
          </div>
          <div class="flex-none p-6 mt-auto overflow-hidden bg-white rounded-t-none rounded-b shadow">
    ...
    <section class="container py-6 mx-auto mb-12 text-center">
      ...
      <a href=""><button class="px-8 py-4 mx-auto my-6 font-bold text-gray-800 transition duration-300 ease-in-out transform bg-white rounded-full shadow-lg lg:mx-0 hover:underline focus:outline-none focus:shadow-outline hover:scale-105">
        Apply!
      </button></a>
    </section>
    <!--Footer-->
          ...
          <div class="flex-1">
            ...
            <ul class="mb-6 list-reset">
              {{--  <li class="inline-block mt-2 mr-2 md:block md:mr-0">
                <a href="" class="text-gray-800 no-underline hover:underline hover:text-pink-500">Apply</a>
              </li>
              <li class="inline-block mt-2 mr-2 md:block md:mr-0">
                <a href="" class="text-gray-800 no-underline hover:underline hover:text-pink-500">Business Loan Checklist</a>
              </li>  --}}
            </ul>
          </div>
        </div>
      </div>
      <a href="" class="text-gray-500">Background vector created by freepik - www.freepik.com</a>
    </footer>
