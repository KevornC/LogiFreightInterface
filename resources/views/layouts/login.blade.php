...
<html lang="en">
  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <nav id="header" class="fixed top-0 z-30 w-full text-white">
      <div class="container flex flex-wrap items-center justify-between w-full py-2 mx-auto mt-0">
        <div class="flex items-center pl-4">
          <a class="text-2xl font-bold text-white no-underline toggleColour hover:no-underline lg:text-4xl" href="/">
            ...
            <img id="Logo" src="image\logo3.png" width="90px;">
          </a>
        </div>
        ...
        <div class="z-20 flex-grow hidden w-full p-4 mt-2 text-black bg-white lg:flex lg:items-center lg:w-auto lg:mt-0 lg:bg-transparent lg:p-0" id="nav-content">
          <ul class="items-center justify-end flex-1 list-reset lg:flex">
            {{--  <li class="mr-3">
              <a class="inline-block px-4 py-2 font-bold text-black no-underline hover:underline" href="">Business Loan CheckList</a>
            </li>
            <li class="mr-3">
              <a class="inline-block px-4 py-2 font-bold text-black no-underline hover:underline" href="">Apply</a>
            </li>  --}}
          </ul>
          @guest
          <a href="{{route('login')}}">
            <button
              {{--  id="navAction"  --}}
              class="inline-block px-4 py-2 font-bold text-black no-underline hover:underline"
            >
              Login
            </button>
            </a>
          <a href="{{route('register')}}">
            <button
              id="navAction"
              class="px-8 py-4 mx-auto mt-4 mr-3 font-bold text-gray-800 transition duration-300 ease-in-out transform bg-white rounded-full shadow opacity-75 lg:mx-0 hover:underline lg:mt-0 focus:outline-none focus:shadow-outline hover:scale-105"
            >
              Register
            </button>
            </a>
      ...
      <hr class="py-0 my-0 border-b border-gray-100 opacity-25" />
        ...
        <div class="pt-24">
          ...
          <section class="pt-10 text-black bg-gray-100">
    ...
    <footer class="bg-white">
          ...
          <div class="flex flex-col w-full py-6 md:flex-row">
            <div class="flex-1 mb-6 text-black">
              <a class="text-2xl font-bold text-pink-600 no-underline hover:no-underline lg:text-4xl" href="{{route('landing')}}">
                <img src="image\logo1.png" id="logo" width="90px">
              </a>
            </div>
            <div class="flex-1">
        ...
        <a href="" class="text-gray-500">LogiFreight Limited</a>
      </footer>
    </div>
